export default {
    id: 'fiveCardCross',
    name: "圣十字牌阵",
    description: "五张牌构成十字，中心为现状，四周揭示过去、未来、目标与潜在基础。",
    useCase: "对单一问题做拓展分析，了解现状、过去、未来、目标与潜意识基础。",
    cardCount: 5,
    slots: [
      { gridX: 5, gridY: 5, meaning: "现状：目前的核心" },
      { gridX: 2, gridY: 5, meaning: "过去/阻碍" },
      { gridX: 8, gridY: 5, meaning: "未来趋势" },
      { gridX: 5, gridY: 2, meaning: "目标：心愿或最佳可能" },
      { gridX: 5, gridY: 8, meaning: "基础：潜意识或原因" }
    ],
    // 十字连接：中心向上下左右
