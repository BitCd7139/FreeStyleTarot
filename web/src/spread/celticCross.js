export default {
    id: 'celticCross',
    name: "凯尔特十字牌阵",
    description: "十张牌组合的中心十字与右侧权杖，能全面解析一件事的过去、现在、未来与各方影响。",
    useCase: "适合需要全面深入分析的复杂问题，如事业走向、重大决策、关系全貌。",
    cardCount: 10,
    slots: [
      { gridX: 3, gridY: 5, meaning: "现状" },
      { gridX: 4, gridY: 5, meaning: "障碍" },
      { gridX: 1, gridY: 5, meaning: "过去" },
      { gridX: 6, gridY: 5, meaning: "未来" },
      { gridX: 3, gridY: 2, meaning: "显意识 (目标)" },
      { gridX: 3, gridY: 8, meaning: "潜意识 (基础)" },
      { gridX: 9, gridY: 8, meaning: "自我" },
      { gridX: 9, gridY: 6, meaning: "环境" },
      { gridX: 9, gridY: 4, meaning: "希望与恐惧" },
      { gridX: 9, gridY: 2, meaning: "最终结果" }
    ],
    // 中心十字 + 右侧权杖竖线
    // 十字：过去→现状→未来（横），显意识→现状→潜意识（纵）
    // 权杖：自我→环境→希望与恐惧→最终结果（从下到上竖线）
    connections: [[2, 0], [0, 3], [4, 0], [0, 5], [6, 7], [7, 8], [8, 9]],
    match: (gridCards) => {
