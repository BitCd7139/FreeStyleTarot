export default {
    id: 'sevenCardEllipse',
    name: "七星阵",
    description: "一张中心牌加六张围绕牌，从性格、财运到健康工作六个维度给出核心建议。",
    useCase: "想从性格、财运、沟通、家庭、恋爱、健康等多个生活维度获取核心建议时使用。",
    cardCount: 7,
    slots: [
      { gridX: 2, gridY: 3, meaning: "性格/当前处境" },
      { gridX: 5, gridY: 1, meaning: "财运/物质" },
      { gridX: 8, gridY: 3, meaning: "兄弟/沟通" },
      { gridX: 8, gridY: 7, meaning: "家庭/根基" },
      { gridX: 5, gridY: 9, meaning: "恋爱/创造力" },
      { gridX: 2, gridY: 7, meaning: "健康/工作" },
      { gridX: 5, gridY: 5, meaning: "核心建议" }
    ],
    // 椭圆环线：6 张外围牌顺次相连
