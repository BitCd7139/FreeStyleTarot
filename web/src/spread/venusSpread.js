export default {
  id: 'venusSpread',
  name: "维纳斯爱情牌阵",
  description: "专为感情设计，左右两侧分别揭示双方真心与表现，底部汇出关系结果。",
  useCase: "专门分析恋爱或亲密关系，了解双方真心、互动与关系走向。",
  cardCount: 7,
  slots: [
    { gridX: 2, gridY: 2, meaning: "询问者的真心" },
    { gridX: 3, gridY: 5, meaning: "询问者受到的影响" },
    { gridX: 4, gridY: 8, meaning: "询问者的外在表现" },
    { gridX: 8, gridY: 2, meaning: "对方的真心" },
    { gridX: 7, gridY: 5, meaning: "对方受到的影响" },
    { gridX: 6, gridY: 8, meaning: "对方的外在表现" },
    { gridX: 5, gridY: 11, meaning: "两人的最终关系结果" }
  ],
  // V 字形汇聚：左侧三人→底部结果，右侧三人→底部结果
  connections: [[0, 1], [1, 2], [2, 6], [3, 4], [4, 5], [5, 6]],
  match: (gridCards) => {
